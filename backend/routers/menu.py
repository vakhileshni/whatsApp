...
def product_to_response(product: Product) -> ProductResponse:
    ...
    return ProductResponse(
        ...
        preparation_time=getattr(product, 'preparation_time', None),
        restaurant_id=getattr(product, 'restaurant_id', None),
...
async def create_product(
    ...
    if product_data.image_url:
        new_product.image_url = product_data.image_url
    if product_data.preparation_time:
        new_product.preparation_time = product_data.preparation_time
...
async def update_product(
    ...
    if product_data.preparation_time is not None:
        product.preparation_time = product_data.preparation_time
